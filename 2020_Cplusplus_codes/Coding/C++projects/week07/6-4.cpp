...
int main()
{
    worker work[7] = {001, "小马", 21, 10000, 002, "小明", 22, 11000, 003, "小红", 20, 9000, 004, "小兰", 22, 9800, 005, "小张", 23, 12000, 006, "小花", 22, 11000, 007, "小刚", 20, 9000};
    fstream iofile("work.dat", ios::in | ios::out | ios::binary);
    if (!iofile)
    {
        cerr << "打开错误!" << endl;
        abort();
